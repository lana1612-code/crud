 ...
 return (
    ...
    <div className="row flex-nowrap">
      ...
      <div className="col py-3">
        ...
        <Input   type={'name'} name={'name'} id={'username'}  title={'user name'} changData={changData}/>
        <Input  type={'email'} name={'email'} id={'email'}  title={'user email'} changData={changData}/>
        <Input  type={'password'} name={'password'} id={'password'}  title={'user password'} changData={changData}/>
