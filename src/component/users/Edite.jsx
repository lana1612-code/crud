...
const sendData = async (e)=>{
  e.preventDefault();
  setLoder(true);
if(Object.keys(valid(users)).length >0){
  console.log(valid(users))
  setError(valid(users))
}
else{
  try{
 ...
 return (
    ...
    <div className="row flex-nowrap">
      ...
      <div className="col py-3">
        ...
        <Input2 value1={users.name}  type={'name'} name={'name'} id={'username'}  title={'user name'} changData={changData}/>
        <Input2 value1={users.email} type={'email'} name={'email'} id={'email'}  title={'user email'} changData={changData}/>
        <Input2 value1={users.password} type={'password'} name={'password'} id={'password'}  title={'user password'} changData={changData}/>
